...
Future<void> setUserMemo({required int idTx, String? memo, required Coin c}) =>
    RustLib.instance.api.crateApiTransactionSetUserMemo(
      idTx: idTx,
      memo: memo,
      c: c,
    );
...
Future<void> setTxCategory({required int id, int? category, required Coin c}) =>
    RustLib.instance.api.crateApiTransactionSetTxCategory(
      id: id,
      category: category,
      c: c,
    );
...
Future<void> setTxPrice({required int id, double? price, required Coin c}) =>
    RustLib.instance.api.crateApiTransactionSetTxPrice(
      id: id,
      price: price,
      c: c,
    );
