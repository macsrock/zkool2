...
// These functions are ignored because they are not marked as `pub`: `build_tor`, `client`, `connect_over_proxy`, `connect_over_tor`, `get_connect_options`, `get_connection`, `get_pool`, `http_connect_tunnel`, `is_mixnet`, `network`, `open_proxied_stream`, `try_open`
...
sealed class Coin with _$Coin {
  ...
  Future<void> getName() =>
      RustLib.instance.api.crateApiCoinCoinGetName(that: this);
  ...
  Coin setLwd({required int serverType, required String url}) => RustLib
      .instance
      .api
  ...
  Coin setTransport({required int transport}) => RustLib.instance.api
      .crateApiCoinCoinSetTransport(that: this, transport: transport);
}
