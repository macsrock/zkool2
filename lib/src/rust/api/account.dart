...
// These functions are ignored because they are not marked as `pub`: `get_ledger`, `sign_ledger_pczt`
...
Future<String?> getAccountFingerprint({
  required int account,
  required Coin c,
}) => RustLib.instance.api.crateApiAccountGetAccountFingerprint(
  account: account,
  c: c,
);
...
Future<void> removeAccount({required int accountId, required Coin c}) => RustLib
    .instance
    .api
...
Future<void> importAccount({
  ...
  required Coin c,
}) => RustLib.instance.api.crateApiAccountImportAccount(
  passphrase: passphrase,
  data: data,
  c: c,
);
...
Future<int> createNewCategory({required Category category, required Coin c}) =>
    RustLib.instance.api.crateApiAccountCreateNewCategory(
      category: category,
      c: c,
    );

Future<void> renameCategory({required Category category, required Coin c}) =>
    RustLib.instance.api.crateApiAccountRenameCategory(
      category: category,
      c: c,
    );
...
Stream<SigningEvent> signLedgerTransaction({
  ...
  required Coin c,
}) => RustLib.instance.api.crateApiAccountSignLedgerTransaction(
  package: package,
  c: c,
);
...
sealed class Folder with _$Folder {
  const factory Folder({required int id, required String name}) = _Folder;
}

@freezed
sealed class FrostParams with _$FrostParams {
  const factory FrostParams({required int id, required int n, required int t}) =
      _FrostParams;
}
...
class Receivers {
  ...
  const Receivers({this.taddr, this.saddr, this.oaddr});
