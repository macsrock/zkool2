...
Future<void> setDkgAddress({
  ...
  required Coin c,
}) => RustLib.instance.api.crateApiFrostSetDkgAddress(
  id: id,
  address: address,
  c: c,
);
...
sealed class DKGStatus with _$DKGStatus {
  ...
  const factory DKGStatus.waitAddresses(List<String> field0) =
  ...
  const factory DKGStatus.sharedAddress(String field0) =
...
sealed class SigningStatus with _$SigningStatus {
  ...
  const factory SigningStatus.transactionSent(String field0) =
